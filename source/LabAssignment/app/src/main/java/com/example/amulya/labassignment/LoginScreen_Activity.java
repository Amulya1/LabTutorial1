...
public class LoginScreen_Activity extends AppCompatActivity {
    ...
    public void userAccess(View v)
    {
        ...
        {
            //This will take us to the webservice page
            Intent redirect = new Intent(LoginScreen_Activity.this, WebService_Activity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_login_screen_, menu);
        return true;
    }
